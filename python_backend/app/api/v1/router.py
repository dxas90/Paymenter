...
from app.api.v1.endpoints import auth, users, services, invoices, tickets, orders, profile, extensions
...
api_router.include_router(extensions.router, prefix="/admin/extensions", tags=["Admin - Extensions"])
